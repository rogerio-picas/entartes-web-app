                                ...
                                {faqs.map(faq => (
                                    <div key={faq.id}>
                                        ...
                                        >
                                            <ChevronRight
                                                size={14}
                                                className={`text-[#4A6362] transition-transform ${
                                            ...
                                            {faq.geral && (
                                                <span className="text-[10px] bg-[#CCE8E6] text-[#006A68] px-1.5 py-0.5 rounded">
                                                    Geral
                                                </span>
                                            )}
