 ...
 * apelido: { type: string }
 * email: { type: string }
 * codigo_username: { type: string }
 * password: { type: string }
 * id_tipo: { type: integer, description: "1-Coordenador, 2-Docente, 3-Aluno" }
 * responses:
 * 201:
 ...
 * type: object
 * properties:
 * oldPassword: { type: string, description: "Password atual" }
 * newPassword: { type: string, description: "Nova password (min 6 chars)" }
 * responses:
 * 200:
 ...
 * properties:
 * email: { type: string }
 * telemovel: { type: string, description: "Formato PT: 9xxxxxxxx" }
 * responses:
 * 200:
